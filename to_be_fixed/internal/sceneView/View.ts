...
export default class View {
  ...
  public get zoomFactor(): number {
    return (
      (this._camera.resolution - this._minZoom) /
  ...
  move(position: IVector2) {
    ...
    newPosition.x =
      this._oldPosition.x -
      position.x * this.camera.invertedResolution * this._invAspectRatio;
    newPosition.y =
      this._oldPosition.y -
      position.y * this.camera.invertedResolution * this._invAspectRatio;
  }
