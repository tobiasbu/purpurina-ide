...
function merge<T>(array: T[], predicate: MergeSortFunction<T>, begin: number, begin_right: number, end: number) {
...
function msort<T>(array: T[], predicate: MergeSortFunction<T>, start: number, end: number) {
    let len = end - start;
