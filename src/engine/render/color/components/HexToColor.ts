...
export default function HexToColor(value: string, source?: Color): IColor {
    ...
    value = value.replace(HEX_SHORTHAND_REGEX_PATTERN,
        function (m, r, g, b, a) {
    ...
    let result = HEX_REGEX_PATTERN.exec(value);
